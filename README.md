...
### Overview
Next week we'll learn how to use scikit-learn to run linear regression models, how goals & business objectives translate to model fit, and also how to optimize models using cross-validation. We will work a lot with housing data and predicting prices. We're going to use these skills to dig into a rich set of data on this project!
